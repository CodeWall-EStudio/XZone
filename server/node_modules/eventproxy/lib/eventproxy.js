...
;(function (name, definition) {
  ...
  EventProxy.prototype.group = function (eventName, callback) {
    ...
    return function (err, data) {
      if (err) {
        return that.emit.apply(that, ['error'].concat(Array.prototype.slice.call(arguments)));
      }
      that.emit(group, {
        index: index,
    ...
    return function (err, data) {
      ...
      if (typeof handler === 'string') {
        ...
        if(callback){
          ...
          return that.emit.apply(that, [handler].concat(Array.prototype.slice.call(arguments)));
        }
      }
